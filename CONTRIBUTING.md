...
`certificate-certainty` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/certificate-certainty
[issue tracker]: https://github.com/<USERNAME>/certificate-certainty/issues
